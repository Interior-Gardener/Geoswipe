/**
 * MultiplayerFlagPage.jsx
 * Page component for multiplayer flag guessing game
...
import MultiplayerFlagGame from "./MultiplayerFlagGame";
...
const MultiplayerFlagPage = () => {
  ...
  const handleCreateRoom = useCallback(() => {
    ...
    joinRoom(newRoomId, inputPlayerName.trim(), 'flag');
  }, [inputPlayerName]);
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Challenge a friend to guess countries by their flags!
          </p>
...
export default MultiplayerFlagPage;
