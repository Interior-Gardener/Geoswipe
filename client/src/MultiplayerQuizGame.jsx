 ...
 * Multiplayer quiz game component
...
const MultiplayerQuizGame = ({ 
  ...
  if (gameState === 'waiting' && players.length < 2) {
    return (
      <div style={containerStyle}>
        <h2 style={titleStyle}>🎯 Multiplayer Quiz</h2>
  ...
  return (
    <div style={containerStyle}>
      ...
      <h2 style={titleStyle}>🎯 Geography Quiz</h2>
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            {currentQuestion.options.map((opt, index) => {
              let optionStyle = {
                ...
                marginBottom: '8px',
                borderRadius: '8px',
                background: selectedCountry === opt 
                  ? 'rgba(0, 212, 255, 0.3)' 
                  : 'rgba(255, 255, 255, 0.1)',
                border: selectedCountry === opt 
                  ? '2px solid #00d4ff' 
                  : '1px solid rgba(255, 255, 255, 0.2)',
                color: 'white',
                fontSize: '14px'
      ...
      {!answered && (
        <p style={{ 
          ...
          🌍 Click the correct country on the globe!
        </p>
      )}
