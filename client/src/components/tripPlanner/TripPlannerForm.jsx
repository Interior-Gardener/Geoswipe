...
const styles = {
  formRoot: {
    background: 'linear-gradient(145deg, rgba(14, 28, 56, 0.56), rgba(35, 23, 74, 0.5))',
    border: '1px solid rgba(236, 221, 255, 0.3)',
    borderRadius: '16px',
    padding: '18px',
    display: 'flex',
    ...
    boxShadow: '0 18px 34px rgba(4, 7, 18, 0.24)',
  },
  headline: {
    fontSize: '20px',
    fontWeight: 800,
  ...
  prefChipActive: {
    background: 'rgba(244, 232, 255, 0.28)',
    borderColor: 'rgba(242, 229, 255, 0.9)',
  },
  submitButton: {
    marginTop: '6px',
    height: '42px',
    borderRadius: '10px',
    border: 'none',
    background: 'linear-gradient(135deg, #0ea5e9, #7c3aed 60%, #ec4899)',
    color: 'white',
    fontWeight: 700,
    cursor: 'pointer',
    boxShadow: '0 10px 20px rgba(2, 8, 20, 0.26)',
  },
};
